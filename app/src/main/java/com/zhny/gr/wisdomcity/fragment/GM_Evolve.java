...
public class GM_Evolve extends BaseFragment_v4 {

    private volatile static GM_Evolve leaderReferral;

    public GM_Evolve() {
    }

    public static GM_Evolve getInstance() {
        if (leaderReferral == null) {
            synchronized (GM_Evolve.class) {
                if (leaderReferral == null) {
                    leaderReferral = new GM_Evolve();
                }
            }
        }
